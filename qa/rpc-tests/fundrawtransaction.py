...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid jamaicacoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid jamaicacoin address" in e.error['message'])
