...
2. run jamaicacoind with -printalert or -sendalert like this:
   /path/to/jamaicacoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.jamaicacoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/JamaicaCoin Core:0.12.0.58/"));
