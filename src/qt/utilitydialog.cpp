    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  jamaicacoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the JamaicaCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 JAM, 0.1 JAM, 1 JAM and 10 JAM -- sort of like the paper money you use every day.</li> \
