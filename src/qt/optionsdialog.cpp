    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("JAM-light"), QVariant("light"));
    ui->theme->addItem(QString("JAM-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("JAM-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("JAM-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("JAM-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("JAM-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("JAM-traditional"), QVariant("trad"));
