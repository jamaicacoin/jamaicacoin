...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in jamaicacoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("jamaicacoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "jamaicacoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "jamaicacoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "jamaicacoin",               "gobject",                &gobject,                true,  {} },
    { "jamaicacoin",               "voteraw",                &voteraw,                true,  {} },
