...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print JamaicaCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "jamaicacoin",               "masternode",             &masternode,             true,  {} },
    { "jamaicacoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "jamaicacoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "jamaicacoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "jamaicacoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "jamaicacoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
