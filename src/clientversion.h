...
//! These need to be macros, as clientversion.cpp's and jamaicacoin*-res.rc's voodoo requires it
...
/**
 * jamaicacoind-res.rc includes this file, but it cannot cope with real c++ code.
