...
official/supported Docker Images found at https://hub.docker.com/r/jamaicacoinpay/jamaicacoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/jamaicacoinpay/jamaicacoind-develop/ when changing the above text**