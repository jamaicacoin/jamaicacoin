...
This mechanism has been integrated into Bitcore-Node-JamaicaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/jamaicacoinpay/insight-api-jamaicacoin#web-socket-api](https://github.com/jamaicacoinpay/insight-api-jamaicacoin#web-socket-api)
* API: [https://github.com/jamaicacoinpay/insight-api-jamaicacoin#instantsend-transactions](https://github.com/jamaicacoinpay/insight-api-jamaicacoin#instantsend-transactions)
...
By default, the JamaicaCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the JamaicaCoin Core daemon:
